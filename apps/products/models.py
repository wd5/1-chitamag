...
class Category(MPTTModel):
    ...
    title_singular = models.CharField(verbose_name=u'название в единственном числе',
        help_text=u'например если категория называется "Пылесосы", то название будет "пылесос" ', max_length=100,
        blank=True)
...
class Product(models.Model):
    ...
    # Дата изменения
    change_date = models.DateTimeField(verbose_name=u'Дата изменения', default=datetime.datetime.now, blank=True,
        null=True)
